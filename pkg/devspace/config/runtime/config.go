...
type Config struct {
	HelmChartHash          string           `yaml:"chartHash,omitempty"`
	DockerLatestTimestamps map[string]int64 `yaml:"dockerLatestTimestamps,omitempty"`
}

// ConfigPath is the relative runtime config path
