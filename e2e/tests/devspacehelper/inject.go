...
// 	ginkgo.FIt("should download devspacehelper in container using curl", func() {
...
// 	ginkgo.FIt("should inject devspacehelper in container via uploading it", func() {
