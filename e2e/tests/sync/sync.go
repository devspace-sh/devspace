...
// 	ginkgo.FIt("devspace sync should override permissions on initial sync", func() {
...
// 	ginkgo.FIt("devspace sync should work with and without config", func() {
...
// 	ginkgo.FIt("should execute a command after sync", func() {
// 		// TODO:
...
// 	ginkgo.FIt("should sync to a pod and detect changes", func() {
...
// 	ginkgo.FIt("should sync to a pod and watch changes", func() {
...
// 	ginkgo.FIt("should sync to a pod and not watch changes with --no-watch", func() {
...
// 	ginkgo.FIt("should sync to a pod container with --container and --container-path", func() {
// 		ginkgo.Skip("error selecting container: couldn't find a pod / container with everything selector")
...
// 	ginkgo.FIt("should sync to a pod container with excludeFile, downloadExcludeFile, and uploadExcludeFile configuration", func() {
// 		ginkgo.Skip("todo")
