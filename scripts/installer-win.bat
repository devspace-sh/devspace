...
set LATEST_RELEASE_API_URL=https://api.github.com/repos/devspace-cloud/devspace/releases/latest
...
set DEVSPACE_EXE="https://github.com/devspace-cloud/devspace/releases/download/%LATEST_VERSION%/devspace-windows-%ARCH_SUFFIX%.exe"
