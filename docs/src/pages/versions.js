...
function Version() {
  ...
  return (
    <Layout
      permalink="/versions"
      description="DevSpace documentation page listing all documented site versions">
      <div className="container margin-vert--xl">
        <h1>DevSpace Versions</h1>
              ...
              <tbody>
                {pastVersions.map(version => (
                  <tr key={version}>
                    ...
                    <td>
                      <a href={`${repoUrl}/releases/tag/v${version}.0`}>
                        Release Notes
                      </a>
                    </td>
                  </tr>
