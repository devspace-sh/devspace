...
import FragmentDependencyProfile from '@site/pages/fragments/dependency-profile.mdx';
import FragmentDependencySkipBuild from '@site/pages/fragments/dependency-skipBuild.mdx';
import FragmentDependencyIgnoreDependencies from '@site/pages/fragments/dependency-ignoreDependencies.mdx';
import FragmentDependencyNamespace from '@site/pages/fragments/dependency-namespace.mdx';
import FragmentDependencyName from '@site/pages/fragments/dependency-name.mdx';
