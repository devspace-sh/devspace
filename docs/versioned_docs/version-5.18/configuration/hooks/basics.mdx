...
- name: "post-image-build-hook"
  command: |
    echo Built Image ${runtime.images.image-1.image}:${runtime.images.image-1.tag}
...
- upload:
    ...
    containerPath: bin
  container:
    imageSelector: ${runtime.images.test.image}:${runtime.images.test.tag}
  events: ["after:deploy:my-deployment"]
  name: "upload-hook"
...
- download:
  ...
  container:
    imageSelector: ${runtime.images.java.image}:${runtime.images.java.tag}
