...
:::info
If using `source: none`, the default value is the fixed value for this variable. It only be changed using a [config patch](../../configuration/profiles/patches.mdx).
:::
