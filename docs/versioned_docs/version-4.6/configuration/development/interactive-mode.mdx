...
The first four options are used to select the appropriate pod / container. If you specify multiple of these config options, they will be jointly used to select the pod / container (think logical `AND / &&`).
:::
