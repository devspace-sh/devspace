...
DevSpace allows you to define different profiles for different use cases (e.g. working on different services in the same project, starting certain debugging enviroments) or for different deployment targets (e.g. dev, staging production).
