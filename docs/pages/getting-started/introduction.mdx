...
<img src={require('@site/static/img/workflow-devspace.png').default} />
...
- The configuration of DevSpace is highly dynamic, so you can configure everything using [config variables](configuration/variables.mdx) that make it much easier to have one base configuration but still allow differences among developers (e.g. different sub-domains for testing)
...
<br/>
<img src={require('@site/static/img/cluster-compatibility.png').default} />

### DevSpace Video Tutorial Series

[![DevSpace Video Tutorial Series Playlist](https://img.youtube.com/vi/9wt4xOCTDpA/maxresdefault.jpg)](https://youtube.com/playlist?list=PL8MSvTvMDqe74oO6AEbo5NE_SdDKFWsy6&si=Aa9fuzExb2WAvU61)
