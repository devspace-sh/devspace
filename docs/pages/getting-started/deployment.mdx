...
import SectionTipUseNamespace from '../sections/tip-use-namespace.mdx';
import SectionNoteCreateSpace from '../sections/note-create-space.mdx';


<figure class="frame">
  <video controls loop autoplay="true">
    <source src="/img/docs/cli/devspace-deploy.mp4" type="video/mp4" />
  </video>
...
```
Learn more about connecting cluster in the [documentation of DevSpace Cloud](https://devspace.cloud/docs/cloud/admin/getting-started/connect-clusters).

:::info DevSpace Cloud On-Premise
Instead of using the SaaS edition of DevSpace Cloud, you can also [install the on-premise edition in your own cluster](https://devspace.cloud/docs/cloud/admin/getting-started/setup).
:::
...
Learn more about how to do this in the [documentation of DevSpace Cloud](https://devspace.cloud/docs/cloud/admin/getting-started/cluster-users).
