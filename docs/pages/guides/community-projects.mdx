...
3. Click on the "**Edit this page**" button or follow **[this link](https://github.com/devspace-cloud/devspace/edit/master/docs/pages/best-practices/community-projects.mdx)**.
