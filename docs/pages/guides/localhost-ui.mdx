...
## Commands
DevSpace allows you to [define custom command](../configuration/commands/basics.mdx) in your project's `devspace.yaml` which allows you to store and execute commonly used commands and share them with other developers.
