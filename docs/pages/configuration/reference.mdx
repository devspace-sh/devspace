...
import SectionConfigImages from '../sections/config-images.mdx';
import SectionConfigDeployments from '../sections/config-deployments.mdx';
import SectionConfigDev from '../sections/config-dev.mdx';
import SectionConfigDependencies from '../sections/config-dependencies.mdx';
import SectionConfigVars from '../sections/config-vars.mdx';
import SectionConfigProfiles from '../sections/config-profiles.mdx';
import SectionConfigCommands from '../sections/config-commands.mdx';
import SectionConfigHooks from '../sections/config-hooks.mdx';
...
[Learn more about configuring the component chart.](https://devspace.sh/docs/component-chart/introduction)
