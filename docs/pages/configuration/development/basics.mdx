---
title: "Basics: Development Mode"
sidebar_label: Basics
---

import SectionWarningMultipleDev from '../../sections/warning-multiple-dev.mdx';
import SectionWorkflowDeployDependencies from '../../sections/workflow-deploy-dependencies.mdx';
import SectionWorkflowBuildImages from '../../sections/workflow-build-images.mdx';
import SectionWorkflowReplaceTags from '../../sections/workflow-replace-tags.mdx';
import SectionWorkflowDeployProject from '../../sections/workflow-deploy-project.mdx';
import SectionNoteGeneralPurposeCommand from '../../sections/note-general-purpose-command.mdx';
import SectionWorkflowOpenLinks from '../../sections/workflow-open-links.mdx';
...
<SectionWorkflowDeployDependencies/>


### 2. Build, Tag &amp; Push Images

<SectionWorkflowBuildImages/>


### 3. Tag Replacement

<SectionWorkflowReplaceTags/>


### 4. Deploy Project

<SectionWorkflowDeployProject/>
...
<SectionNoteGeneralPurposeCommand/>
...
```
To use the second option, you either need to make sure the DNS of your domain points to your Kubernetes cluster and you have an ingress-controller running in your cluster OR you use [DevSpace Cloud](https://devspace.cloud/docs/cloud/introduction), either in form of Hosted Spaces or by connecting your own cluster using the command `devspace connect cluster`.
