...
The component chart is a flexible Helm chart for deploying custom applications in a standardized manner. Learn more about [configuring the values for component chart deployments](https://devspace.sh/component-chart/docs/introduction).
:::
