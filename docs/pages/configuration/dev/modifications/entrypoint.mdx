...
If you [enable the `terminal`](../workflow/terminal.mdx) for this dev container, DevSpace will assume that you manually want to start your application using the terminal session and it automatically changes the container entrypoint to `sleep`:
