...
### `rebuildStrategy` <span className="config-field-required" data-required="false">required</span> <span className="config-field-type">string</span> <span className="config-field-default">default</span> <span className="config-field-enum"><span>default<br/>always<br/>ignoreContextChanges</span></span> <span id="images-rebuildStrategy"></span>
