...
:::note
See **[Best Practices for Image Building](../../best-practices/image-building.mdx)** for details on how to optimize your Dockerfiles and use `.dockerignore` for faster image building.
:::
