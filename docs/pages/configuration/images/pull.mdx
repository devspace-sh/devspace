...
### Automatic
DevSpace can automatically create pull secrets to provide registry credentials for Kubernetes to pull images from private registries.

The following pipeline functions trigger pull secrets to be created:
