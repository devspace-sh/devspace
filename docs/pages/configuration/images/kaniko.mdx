...
If you use the `pullSecret` option, you have to create the secret before DevSpace tries to build your images. You can automate this by [using the pullSecrets feature](../../configuration/pullSecrets/basics.mdx) as shown in this example:
```yaml
pullSecrets: 
