...
If you use the `pullSecret` option, you must create the secret before DevSpace tries to build your images. You can automate this by [using the pullSecrets feature](../../pullSecrets/index.mdx) as shown in this example:
```yaml
pullSecrets:
