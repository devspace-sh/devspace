...
4. Either [streams the logs of your containers](/docs/cli/development/configuration/logs-streaming) OR starts the [terminal proxy](/docs/cli/development/configuration/interactive-mode#devinteractiveterminal)
...
> - **Option 1: Edit the ENTRYPOINT in your Dockerfile** (easy and simple to share with others but often requires to setup a [separate profile for staging or production-like deployments](/docs/cli/configuration/profiles-patches))
