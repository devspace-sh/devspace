...
- Add new [predefined variables](../configuration/variables/index.mdx)
...
This section specifies which [predefined variables](../configuration/variables/index.mdx) are added to DevSpace. These variable values will be retrieved from the plugin binary instead of asking the user. It expects an array with objects that can have the following properties:
