...
3. If you want to connect a domain to a service, you need to [configure an ingress for this service](../../../../cli/deployment/components/configuration/ingress).
